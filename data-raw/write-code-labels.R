...
documented_factors <- c(
  ...
  "creatininePretreatmentUnitOfMeasure", "date1stCrsRxCocFlag",
  "dateConclusiveDxFlag", "dateInitialRxSeerFlag", "dateOf1stContactFlag",
  "dateOfBirthFlag", "dateOfDeathCanadaFlag", "dateOfDiagnosisFlag",
  "dateOfInptAdmFlag", "dateOfInptDischFlag", "dateOfLastCancerStatusFlag",
  "dateOfLastContactFlag", "dateOfMultTumorsFlag",
  "dateRegionalLymphNodeDissectionFlag", "dateSentinelLymphNodeBiopsyFlag",
  "derivedAjccFlag", "derivedSeerClinStgGrp", "derivedSeerCmbMSrc",
  "derivedSeerCmbNSrc", "derivedSeerCmbStgGrp", "derivedSeerCmbTSrc",
  "derivedSeerPathStgGrp", "derivedSummaryStage2018", "diagnosticConfirmation",
  ...
  "lymphVascularInvasion", "majorVeinInvolvement", "maritalStatusAtDx",
